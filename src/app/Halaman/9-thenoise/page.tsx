...
export default function InvestingPage() {
  ...
  useEffect(() => {
    ...
    const savedLayout = localStorage.getItem("layout-9");
    if (savedLayout) {
  ...
  function toggleLayout(): void {
    ...
    setIsGrid(newLayout);
    localStorage.setItem("layout-9", newLayout ? "grid" : "normal");
